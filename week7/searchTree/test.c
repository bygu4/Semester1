...
static bool testForFindKeyAndGetData(void)
{
    ...
    if (tree == NULL)
    {
        printf("Failed to create tree in testForGetData\n");
        return false;
    }
    ...
    {
        freeTree(&tree);
        printf("Failed to add keys in testForGetData\n");
        return false;
    }
    ...
    {
        freeTree(&tree);
        printFailedTest(1, "testForGetData");
        return false;
    }
    ...
    {
        freeTree(&tree);
        printFailedTest(2, "testForGetData");
        return false;
    }
    ...
    {
        freeTree(&tree);
        printFailedTest(3, "testForGetData");
        return false;
    }
    ...
    if (!testFourIsPassed)
    {
        printFailedTest(4, "testForGetData");
        return false;
    }
