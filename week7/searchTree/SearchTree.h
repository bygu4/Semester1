...
// добавление в дерево по ключу. Возвращает наличие ошибки при выделении памяти
...
// проверка наличия данного ключа в дереве
bool findKey(const SearchTree* const tree, const int key);

// удаление элемента по ключу. Если элемент удален, возвращает true, иначе - false
...
// проверка корректности построения дерева проходом в ширину
